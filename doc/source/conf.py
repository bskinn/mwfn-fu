...
# -*- coding: utf-8 -*-
#
# mwfn-fu documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'mwfn-fu.tex', 'mwfn-fu Documentation',
     'Brian Skinn', 'manual'),
]
...
man_pages = [
    (master_doc, 'mwfn-fu', 'mwfn-fu Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mwfn-fu', 'mwfn-fu Documentation',
     author, 'mwfn-fu', 'One line description of project.',
     'Miscellaneous'),
]
